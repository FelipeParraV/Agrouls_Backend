<?php
    ...
    switch ($method) {
        case 'GET':
            ...
            $sql = "SELECT * FROM escuela_1 ORDER BY orden";
        ...
        case 'POST':
            ...
            if ($action === 'new') {
                $sql = "SELECT orden FROM escuela_1 ORDER BY orden DESC LIMIT 1"; // Consulta SQL para obtener el último orden
                ...
                $sql = "INSERT INTO escuela_1 (presentacion, orden) VALUES ('$presentacion', '$orden')";
                ...
                foreach ($items as $item) {
                    $id = $item['id'];
                    $order = $item['order'];
                    $sql = "UPDATE escuela_1 SET orden = ? WHERE id = ?";
        ...
        case 'PUT':
            ...
            $sql = "UPDATE escuela_1 SET presentacion='$presentacion' WHERE id=$id";
        ...
        case 'DELETE':
            ...
            $sql = "DELETE FROM escuela_1 WHERE id=$id"; // Consulta SQL para eliminar el registro
            if ($conn->query($sql) === TRUE) { // Si la consulta se ejecuta correctamente
